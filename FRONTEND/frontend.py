...
#             # Atualizar ou ajustar dinamicamente as barras de progresso das filas de processamento
#             num_filas = len(estado["filas_processamento"])
#             if num_filas > self.num_filas_processamento:
#                 # Adiciona novas barras de progresso se houver mais filas de processamento no backend
#                 for i in range(self.num_filas_processamento, num_filas):
#                     barra = QProgressBar()
#                     barra.setMaximum(10)
#                     barra.setValue(0)
...
#                 # Remove as barras de progresso se houver menos filas de processamento no backend
