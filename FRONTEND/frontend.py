...
# Configurar o PyQt5 para rodar em modo "offscreen" se necessário (especialmente se estiver em contêiner)
# os.environ["QT_QPA_PLATFORM"] = "offscreen"

# Definir um caminho para fontes adicionais, caso esteja faltando
# Adicione aqui o caminho local para fontes, se necessário
font_path = "/path/to/fonts"
if os.path.exists(font_path):
    os.environ["QT_QPA_FONTDIR"] = font_path
...
class PassagensUI(QMainWindow):
    ...
    def atualizar_interface(self):
        # Obter dados do backend
        try:
            # Atualize o endereço para conectar-se ao backend localmente
